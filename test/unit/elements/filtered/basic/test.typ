...
#show: e.filtered(wibble.with(number: 10), e.set_(wobble, color: orange))
#show: e.filtered(wibble.with(number: 20), e.apply(e.set_(wobble, color: purple), e.set_(wobble, inner: [twenty])))
